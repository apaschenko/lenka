...
const CollectionTypesSet = [...VocabularyTypesSet, 'set']; // Yes, all the vocabularies are collections too.
...
const ParamsCollectionActionsSet = ['replace', 'union', 'diff'];
const ParamsVocabularyActionSet = [...ParamsCollectionActionsSet, 'stack'];
