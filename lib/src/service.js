...
class Source {
    ...
    createChild(producedBy, producedAs) {
        ...
        if (this._isItAPrimitive) {
            childRawData = exports.MISSING;
        }
        else {
            switch (producedAs) {
                case 'key':
                    childRawData = this._value.get(producedBy);
                    break;
                case 'property':
                    childRawData = this._value[producedBy];
                    break;
                case 'value':
    ...
    changeResult(result) {
        if (this._parentSource) {
            ...
            switch (this._producedAs) {
                case 'property':
                    this._parentSource[this._producedBy] = result;
                    break;
                case 'key':
                    this._parentSource.set(this._producedBy, result);
                    break;
                case 'value':
                    this._parentSource.delete(this._target);
                    this._parentSource.add(result);
                    break;
                default:
