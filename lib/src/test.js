// import { clone, CustParamsAccSoft, CustParamsAccStrict, BY_DEFAULT } from '../src';
// const commons = {
//   c: 'cc',
//   d: 'dd'
// }
...
// const acc = { a, summ: 0 };
// clone(a)
// function customizerSoft(params: CustParamsAccSoft<typeof acc>): any {
//   const { accumulator } = params;
//   accumulator.missingKey = 'some value';
//   accumulator.summ++;
//   return BY_DEFAULT;
// }
